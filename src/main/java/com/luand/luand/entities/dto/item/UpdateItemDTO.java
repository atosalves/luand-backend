...
public record UpdateItemDTO(
        ...
        @NotBlank(message = "Color is required") @jakarta.validation.constraints.Size(min = 7, max = 9, message = "Color must be between 7 and 9 characters")
        // TODO: alter later
        String color,
        ...
        @NotNull(message = "Fashion line is required") Long fashionLineDTO) {
